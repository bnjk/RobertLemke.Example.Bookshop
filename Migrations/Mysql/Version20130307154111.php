...
class Version20130307154111 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("CREATE TABLE robertlemke_example_bookshop_domain_model_user (persistence_object_identifier VARCHAR(40) NOT NULL, department VARCHAR(255) NOT NULL, PRIMARY KEY(persistence_object_identifier)) ENGINE = InnoDB");
